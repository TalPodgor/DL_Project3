...
def rgb_semantic_to_ids(seg_rgb, threshold=75):
    ...
    bright_enough = np.max(flat, axis=1) >= 70
...
class V5ObliqueDataset(BaseDataset):
    ...
    def modify_commandline_options(parser, is_train):
        ...
        parser.add_argument("--v5_semantic_source", choices=["fen", "silhouette"], default="fen")
        return parser
    ...
    def _silhouette_transform(self, seg_rgb, params):
        ids = rgb_semantic_to_ids(seg_rgb, self.opt.seg_color_threshold)
